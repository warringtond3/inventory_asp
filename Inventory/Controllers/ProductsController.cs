...
namespace Inventory.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            var inventoryContext = _context.Products.Include(p => p.Category).Include(p => p.Supplier);
        ...
        public async Task<IActionResult> Create([Bind("ProductId,ProductName,CategoryId,SupplierId,QuantityPerUnit,UnitPrice,UnitsInStock,UnitsOnOrder,ReorderLevel,Discontinued")] Product product)
        {
